...
\newcommand{\fondo}[1]{
    ...
    % Agrega el tamaño, si es celeste colocar -14mm si es blanco -10mm
    % con un condicional
    \ifthenelse{\equal{#1}{blanco}}{\addtolength{\headsep}{14mm}}{\addtolength{\headsep}{-14mm}}
    }
...
\usecolortheme{orchid}
    ...
    \setbeamertemplate{footline}{
        \begin{beamercolorbox}[wd=\textwidth, center, sep=15.5mm]{footline}%
